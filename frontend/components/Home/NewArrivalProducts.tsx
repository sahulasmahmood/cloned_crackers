...
export default function NewArrivalProducts({ products }: NewArrivalProductsProps) {
      ...
      <div className="container mx-auto px-3 sm:px-4">
        ...
        <div className="flex items-center justify-between mb-3 sm:mb-4 md:mb-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500">Discover our latest products</p>
          </div>
          <Link 
            href="/products" 
