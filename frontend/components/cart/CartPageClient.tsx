    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-600 mb-4 sm:mb-8">
          ...
          <span>/</span>
          <span className="text-gray-900">Enquiry List</span>
        </nav>
        ...
        <div className="mb-4 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600">
            There are {totalItems} products in your Enquiry List
          </p>
        </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 sm:p-12 text-center">
            <div className="w-16 h-16 sm:w-24 sm:h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <IconClipboardList size={32} className="text-gray-400 sm:hidden" />
              <IconClipboardList
                size={48}
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-8">
              Looks like you have not added any items to your Enquiry List yet.
            </p>
            <Link
              href="/products"
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-red-700 space-y-1">
                        ...
                        <p className="font-medium mt-2">
                          Please remove out-of-stock items or adjust quantities before requesting quotation.
                        </p>
                      </div>
                    </div>
                  </div>
