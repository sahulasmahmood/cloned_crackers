                  ...
                  {productImages.map((image, index) => (
                    ...
                    >
                      {image && image !== "/placeholder-product.png" ? (
                        <Image
                          src={image}
                          alt={`${product.shortDescription} - Image ${index + 1
                            }`}
                          width={80}
                          height={80}
              ...
              <div className="flex items-start justify-between gap-3 mb-2 sm:mb-3">
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                  ...
                  >
                    <IconHeart
                      size={20}
                      className={`sm:w-6 sm:h-6 transition-colors ${isWishlisted ? "fill-red-500 text-red-500" : "text-gray-600"
                        }`}
                    />
                  </button>
                    ...
                    {product.variants.map((variant, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg border-2 text-xs sm:text-sm font-medium transition-colors ${selectedVariant === index
                              ? variantInactive
